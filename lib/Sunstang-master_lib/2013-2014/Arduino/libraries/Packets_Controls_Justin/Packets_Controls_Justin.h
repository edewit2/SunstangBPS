...
*/
#ifndef PACKETS_CONTROLS_JUSTIN_H
#define PACKETS_CONTROLS_JUSTIN_H
...
namespace Packets_Controls_Justin {
	
	struct Packet_HighPriority {
		uint16_t voltageInstantaneous; //an instantaneous voltage reading and the time it was read at
		uint32_t time;
	} packet0;
	...
	SlaveNode slaveNode(0x01, SETUP(packetList));
