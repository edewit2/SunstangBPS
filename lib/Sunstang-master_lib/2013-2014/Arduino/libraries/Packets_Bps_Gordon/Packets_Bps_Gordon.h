...
*/
#ifndef PACKETS_BPS_GORDON_H
#define PACKETS_BPS_GORDON_H
...
namespace Packets_Bps_Gordon {
	
	struct Packet_HighPriority {
		uint8_t batteryVoltageRaw;
		uint8_t batteryTempRaw;
		bool isGordonDancing;
	...
	SlaveNode slaveNode(0x05, SETUP(packetList));
