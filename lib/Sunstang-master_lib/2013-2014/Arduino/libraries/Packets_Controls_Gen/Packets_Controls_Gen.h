/*
Author: Geneviève Favreau
Date:   30/11/13 [dd,mm,yy]
Time:   Way too early in the morning ( 2:00am on the dot :P )
*/
...
*/
#ifndef PACKETS_CONTROLS_GEN_H
#define PACKETS_CONTROLS_GEN_H
...
namespace Packets_Controls_Gen {
	
	struct Packet_HighPriority {
		uint8_t GensAwesomeVariable0;
		uint8_t GensAwesomeVariable1;
	} packet0;
