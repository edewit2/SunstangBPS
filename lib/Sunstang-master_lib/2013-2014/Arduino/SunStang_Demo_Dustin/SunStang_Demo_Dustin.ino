...
#include "Packets_Demo_Dustin.h"

using namespace Packet_Demo_Dustin;
...
void updatePacket0() {
	static int n = 0;
	packet0.time = n;//analogRead(0);
	packet0.voltageInst = 255 - n;//analogRead(1);
	n++;
}

void updatePacket1() {
	static int n = 0;
	packet1.voltageAvg[0] += n;//3.14159265358979323846264338327950;
