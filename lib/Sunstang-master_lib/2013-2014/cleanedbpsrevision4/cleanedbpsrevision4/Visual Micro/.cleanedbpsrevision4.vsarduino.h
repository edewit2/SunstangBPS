...
void isolateBattery();
void killCar();
byte waitAndGetNextByte();
byte waitAndPeekNextByte();
void flushReplyBytes();

#include "D:\Program Files\arduino-1.0.3\hardware\arduino\cores\arduino\arduino.h"
#include "D:\Program Files\arduino-1.0.3\hardware\arduino\variants\eightanaloginputs\pins_arduino.h" 
#include "D:\My Documents\GitHub\SunStang\cleanedbpsrevision4\cleanedbpsrevision4\cleanedbpsrevision4.ino"
#endif
