...
HEAD byte waitForByteThenPeek();
master void inactiveMode(byte input);
...
#include "D:\My Documents\GitHub\SunStang\Arduino_Test\TESTER_SunStang_BPS\TESTER_SunStang_BPS.ino"
#endif
