...
const int16_t ABSOLUTE_OVER_VOLTAGE                 = 4.15 / VOLTAGE_PER_INT16; // Threshold: 4.15 V (Units: 4.883 mV/integer)
const int16_t ABSOLUTE_UNDER_VOLTAGE                = 2.80 / VOLTAGE_PER_INT16; // Threshold: 2.80 V (Units: 4.883 mV/integer)
const int16_t ABSOLUTE_OVER_TEMPERATURE_CHARGING    = 45 / TEMPERATURE_PER_INT16; // Threshold: 45 Celcius (Units: 0.125 Celcius/integer)
const int16_t ABSOLUTE_OVER_TEMPERATURE_DISCHARGING = 60 / TEMPERATURE_PER_INT16; // Threshold: 60 Celcius (Units: 0.125 Celcius/integer)
const int16_t ABSOLUTE_OVER_CURRENT                 = 28800; // Threshold: 27 A (Units: (1.5625uV/Rsns)/integer, Rsns = 1.5mOhms)
