...
Init2510	call	Reset2510
		...
		SPI_WriteL CNF1,0x00	; config register 1 of MCP2510 (Bitiming)

		SPI_WriteL CNF2,0x89	; config register 2 of MCP2510

		SPI_WriteL CNF3,0x04	; config register 3 of MCP2510
