...
void init_Timer1(void)
{
    ...
    */
    ...
    GIE = 1;           // Global interrupt enable (INTCON register)
    PEIE = 1;          // Peripheral interrupt enable (INTCON register)
    TMR1IE = 1;        // Enables the TMR1 overflow interrupt (PIE register)
    TMR1IF = 0;        // Clear TMR1 overflow Flag bit (PIR register)
